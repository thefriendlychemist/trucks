        ...
        <ul className="mt-12 grid gap-6 md:grid-cols-3">
          {services.map((service) => (
            <li key={service.title} className="bg-white p-7">
              <h3 className="font-[family-name:var(--font-display)] text-2xl font-bold tracking-wide text-navy uppercase">
                {service.title}
              </h3>
              ...
              <a
                href="#location"
                className="mt-6 inline-block text-sm font-bold tracking-wide text-red uppercase transition-colors hover:text-red-hot"
              >
                Learn more
              </a>
            </li>
